...
if not NEXE_FLOW_AVAILABLE:
  # nexe_flow is not installed → the SanitizerNode workflow node cannot be
  ...
  SanitizerNode = None  # type: ignore[assignment,misc]
else:
  class SanitizerNode(Node):  # type: ignore[no-redef]
    """
