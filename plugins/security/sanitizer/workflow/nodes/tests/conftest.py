...
def _create_nexe_flow_mock():
    """Create minimal nexe_flow mock with Node, NodeMetadata, NodeInput, NodeOutput."""
    ...
    sys.modules.setdefault("nexe_flow", nexe_flow)
    sys.modules.setdefault("nexe_flow.core", nexe_flow_core)
    sys.modules.setdefault("nexe_flow.core.node", nexe_flow_core_node)
