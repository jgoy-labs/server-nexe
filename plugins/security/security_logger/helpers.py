...
class SecurityLoggerHelpers:
  ...
  def log_auth_failure(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
  ...
  def log_path_traversal(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    attempted_path: str,
    ip_address: Optional[str] = None,
    endpoint: Optional[str] = None,
  ...
  def log_rate_limit_exceeded(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    ip_address: Optional[str] = None,
    endpoint: Optional[str] = None,
  ...
  def log_module_rejected(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    module_name: str,
    reason: str,
  ) -> None:
  ...
  def log_config_validation_failed(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    config_key: str,
    reason: str,
  ...
  def log_xss_attempt(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    input_data: str,
    ip_address: Optional[str] = None,
    endpoint: Optional[str] = None,
  ...
  def log_sql_injection_attempt(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    input_data: str,
    ip_address: Optional[str] = None,
    endpoint: Optional[str] = None,
  ...
  def log_command_injection_attempt(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    input_data: str,
    ip_address: Optional[str] = None,
    endpoint: Optional[str] = None,
  ...
  def log_invalid_content_type(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    content_type: str,
    ip_address: Optional[str] = None,
    endpoint: Optional[str] = None,
  ...
  def log_request_too_large(  # type: ignore[misc]  # FP: mixin, self is SecurityEventLogger by inheritance invariant (SecurityEventLogger(SecurityLoggerHelpers))
    self: "SecurityEventLogger",
    size: int,
    max_size: int,
    ip_address: Optional[str] = None,
