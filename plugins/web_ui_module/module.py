...
class WebUIModule:
    ...
    def _init_router(self):
        ...
        # Chat endpoint: handled by manifest.py (complete implementation with RAG,
        # compaction, memory intent detection). Removed from module.py to avoid
        # duplicate /ui/chat route conflict.
