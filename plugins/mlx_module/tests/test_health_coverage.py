"""Tests for plugins/mlx_module/health.py — coverage gaps."""
import asyncio
import pytest
...
class TestGetHealthInEventLoop:
    ...
    def test_initialized_returns_healthy(self):
        ...
        with patch("plugins.mlx_module.manifest.get_module_instance", return_value=mock_module):
            from plugins.mlx_module.health import get_health
        ...
        assert result["module"] == "mlx_module"
