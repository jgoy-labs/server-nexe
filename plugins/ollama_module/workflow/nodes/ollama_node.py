  ...
  def get_metadata(self) -> NodeMetadata:
    ...
    return NodeMetadata(
      ...
      description=_t(
        ...
        "Generate text using local Ollama (llama, mistral, etc.)"
      ),
      category="llm",
      inputs=[
        NodeInput(
          ...
          required=True,
          description=_t(
            "workflow.node.input_prompt_description",
        ...
        NodeInput(
          ...
          default="llama3.2",
          description=_t(
            "workflow.node.input_model_description",
            "Ollama model (llama3.2, mistral, etc.)"
          )
        ),
        NodeInput(
          name="temperature",
          ...
          default=0.7,
          description=_t(
            "workflow.node.input_temperature_description",
            "Creativity 0.0-2.0 (higher = more creative)"
          )
        ),
        NodeInput(
          name="max_tokens",
          ...
          default=None,
          description=_t(
            "workflow.node.input_max_tokens_description",
            "Maximum tokens to generate (None = unlimited)"
          )
        ),
        NodeInput(
          name="system",
          ...
          default=None,
          description=_t(
            "workflow.node.input_system_description",
      ...
      outputs=[
        NodeOutput(
          ...
          type="string",
          description=_t(
            "workflow.node.output_response_description",
        ...
        NodeOutput(
          ...
          type="string",
          description=_t(
            "workflow.node.output_model_description",
            "Model used"
          )
        ),
        NodeOutput(
          ...
          type="number",
          description=_t(
            "workflow.node.output_tokens_description",
