...
# Resolve the routes_chat.py source path via package location
import plugins.web_ui_module as _web_ui_pkg
ROUTES_CHAT_PATH = Path(_web_ui_pkg.__file__).parent / "api" / "routes_chat.py"
