...
# ═══════════════════════════════════════════════════════════════════════════
# A-1: Upload — Path Traversal & Extension Whitelist
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# A-3: Health Endpoint — Informació mínima sense auth
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# A-6: Session TTL — Memory Leak Prevention
# ═══════════════════════════════════════════════════════════════════════════
