...
abstract: "Identitat de server-nexe: projecte de codi obert creat per Jordi Goy a Barcelona. Que es, que NO es (no es npm nexe, no es Ollama, no es ChatGPT), que fa (IA local, RAG, multi-backend, encriptacio at-rest), estat actual (1.0.5, macOS 14+ Apple Silicon only), enllacos oficials i com donar suport."
...
- **macOS 14+ Apple Silicon**, versio 1.0.5
...
- **Tests:** 6723 funcions de test col·lectades (6938 totals — 215 deselected per marcadors), 0 errors a l'ultima execucio
...
- 14 fitxers tematics que cobreixen identitat, arquitectura, API, seguretat, testing, etc.
