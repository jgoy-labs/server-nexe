...
# Seguretat — server-nexe 1.0.3-beta
...
server-nexe 1.0.3-beta esta dissenyat per a entorns locals de confiança. Totes les dades es queden al dispositiu. Sense telemetria, sense crides externes.
