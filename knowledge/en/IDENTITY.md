...
abstract: "Core identity of server-nexe: open-source project created by Jordi Goy in Barcelona. What it is, what it is NOT (not npm nexe, not Ollama, not ChatGPT), what it does (local AI, RAG, multi-backend, encryption at-rest), current status (1.0.3-beta, macOS 14+ Apple Silicon only), official links and how to support."
...
- **macOS 14+ Apple Silicon**, version 1.0.3-beta
