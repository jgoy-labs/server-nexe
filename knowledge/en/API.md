...
# REST API Reference — server-nexe 1.0.4-beta
...
|----------|--------|------|------------|-------------|
| `/v1/memory/store` | POST | Yes | `NEXE_RATE_LIMIT_MEMORY` (default 30/min) | Store text to a collection |
...
| `/v1/embeddings/models` | GET | No | List available embedding models (stub, 501) |
