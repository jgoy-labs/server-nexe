...
├── tests/                        # 6776 funciones de test recopiladas (6991 totales)
└── nexe                          # Ejecutable CLI
```
...
- 6776 funciones de test recopiladas (6991 totales — 215 deselected por marcadores), 0 fallos en la ultima ejecucion
