...
abstract: "Errores comunes y soluciones para server-nexe 1.0.4-beta. Cubre errores de instalacion, arranque del servidor, Web UI, autenticacion API, carga de modelos, memoria/RAG, streaming, errores de encriptacion y fixes de Bug #19 (MEK fallback, personal_memory wipe)."
...
# Errores comunes — server-nexe 1.0.4-beta
...
- **Version**: la veras en el menu del tray como `server.nexe v1.0.4-beta` (o ejecuta `./nexe --version`)
