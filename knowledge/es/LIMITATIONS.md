...
- ⚠️ **Raspberry Pi:** Código implementado, **nunca probado en real**
- ⚠️ **Windows:** Código implementado, **nunca probado en real**

**Implicaciones:**
- Si pruebas NEXE en Linux/RPi/Windows, eres un **early adopter**
...
**Soportado:**
- ✅ ARM64 (Apple Silicon, RPi 4/5) - Testeado en Apple Silicon
- ✅ x86_64 (Intel/AMD) - Testeado en Intel Mac

**Limitado:**
- ⚠️ ARMv7 (RPi 3 y anteriores) - Puede ser demasiado lento, **no testeado**
...
**Modelo actual:** `paraphrase-multilingual-MiniLM-L12-v2` (768 dimensiones)
...
- ❌ `/v1/embeddings` - Planeado para FASE 15, actualmente 0% funcional
...
- ✅ **Soporte dual-key** con fechas de expiración (Phase 2.1)
...
1. **✅ Modelo de embeddings actualizado**
   - Antes: `all-MiniLM-L6-v2` (384 dims)
   - Ahora: `paraphrase-multilingual-MiniLM-L12-v2` (768 dims)
...
3. **✅ Compatibilidad OpenAI CORREGIDA**
   ...
   - Ahora: `/v1/embeddings` **NO implementado** (501), planeado FASE 15
...
- ❌ Solo testeado en macOS - Linux/Windows/RPi no testeados
