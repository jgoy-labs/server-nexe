...
@router_public.get("/stats/{user_id}", dependencies=[Depends(require_api_key)], operation_id="memory_stats")
...
@router_public.get("/profile/{user_id}", dependencies=[Depends(require_api_key)], operation_id="memory_profile")
