...
class MemoryAPI:
  ...
  async def scroll(
    ...
    def _scroll():
      ...
      assert self._qdrant is not None  # nosec B101  # _ensure_initialized() guards above (pyright narrowing)
  ...
  async def _generate_embedding(self, text: str) -> List[float]:
    ...
    def _encode():
      ...
      import numpy as _np
      assert self._embedder is not None  # nosec B101  # _ensure_initialized() guards above (pyright narrowing)
