...
T = {
    "ca": {
        ...
        "uninstall_warning": "Això esborrarà TOTA la instal·lació de Nexe a:\n\n{path}\n\nInclou:\n• Models descarregats\n• Memòria i converses\n• Base de coneixement\n• Configuració\n\n{storage}\n\nAquesta acció NO es pot desfer.",
    ...
    "es": {
        ...
        "uninstall_warning": "Esto borrará TODA la instalación de Nexe en:\n\n{path}\n\nIncluye:\n• Modelos descargados\n• Memoria y conversaciones\n• Base de conocimiento\n• Configuración\n\n{storage}\n\nEsta acción NO se puede deshacer.",
    ...
    "en": {
        ...
        "open_logs": "📄 Open logs",
        "docs": "📖 Documentation",
        # RAM of the server-nexe process (NOT the LLM model's RAM)
        "ram": "🧠 Server RAM: {ram}",
        "venv_not_found": "Python environment not found. Please run the installer again.",
        ...
        "uninstall_warning": "This will DELETE the entire Nexe installation at:\n\n{path}\n\nIncludes:\n• Downloaded models\n• Memory and conversations\n• Knowledge base data\n• Configuration\n\n{storage}\n\nThis action CANNOT be undone.",
