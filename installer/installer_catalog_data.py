...
MODEL_CATALOG = {
    ...
    "large": [
        ...
        },
        {
            ...
            "disk_gb": 21.0,
            "ram_gb": 21,
            "description": {"ca": "Velocitat de 9B amb qualitat de 35B. Thinking excel·lent, visió (VL). Apache 2.0.", "es": "Velocidad de 9B con calidad de 35B. Thinking excelente, visión (VL). Apache 2.0.", "en": "9B speed with 35B quality. Excellent thinking, vision (VL). Apache 2.0."},
        ...
        },
        {
            ...
            "disk_gb": 50.0,
            "ram_gb": 48,
            "description": {"ca": "Màxim per a codi i agents. Thinking excel·lent, visió (VL). Apache 2.0.", "es": "Máximo para código y agentes. Thinking excelente, visión (VL). Apache 2.0.", "en": "Maximum for code and agents. Excellent thinking, vision (VL). Apache 2.0."},
