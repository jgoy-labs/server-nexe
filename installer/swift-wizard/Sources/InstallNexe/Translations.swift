...
struct T {
    ...
    static let translations: [Lang: [String: String]] = [
        .ca: [
            ...
            "existing_install_msg": "Ja hi ha una instal·lacio de Nexe a:\n\n%@\n\nQue vols fer?\n\n• Copia: mourem l'actual a %@ i n'instal·larem una de nova.\n• Sobreescriure: s'eliminara i es reinstal·lara (sense recuperacio).",
            "existing_install_backup": "Fer copia i continuar",
            "existing_install_overwrite": "Sobreescriure",
            "existing_install_change": "Triar altra carpeta",
            "backup_done_title": "Copia creada",
            "backup_done_msg": "L'instal·lacio anterior s'ha mogut a:\n\n%@\n\nPots esborrar-la manualment quan vulguis.",
            ...
            "model_test_mode": "MODE PROVA — RAM simulada: %@ GB (real: %@ GB). El wizard tria els models segons aquest número, no segons la teva màquina.",
            ...
            "model_catalog_error": "No s'ha pogut carregar el cataleg de models. La llista es buida per aquest motiu, no perque no hi hagi models per a la teva maquina.",
        ...
        .es: [
            ...
            "existing_install_msg": "Ya hay una instalacion de Nexe en:\n\n%@\n\n¿Que quieres hacer?\n\n• Copia: moveremos la actual a %@ e instalaremos una nueva.\n• Sobreescribir: se eliminara y reinstalara (sin recuperacion).",
            "existing_install_backup": "Hacer copia y continuar",
            "existing_install_overwrite": "Sobreescribir",
            "existing_install_change": "Elegir otra carpeta",
            "backup_done_title": "Copia creada",
            "backup_done_msg": "La instalacion anterior se ha movido a:\n\n%@\n\nPuedes eliminarla manualmente cuando quieras.",
            ...
            "model_tab_tier_24": "24 GB",
            "model_tab_tier_32": "32 GB+",
            "model_test_mode": "MODO PRUEBA — RAM simulada: %@ GB (real: %@ GB). El wizard elige los modelos según este número, no según tu máquina.",
            "model_tab_tier_48": "48 GB",
            "model_tab_tier_64": "64 GB",
            "model_engine": "Motor",
            ...
            "model_catalog_error": "No se ha podido cargar el catalogo de modelos. La lista esta vacia por este motivo, no porque no haya modelos para tu maquina.",
        ...
        .en: [
            ...
            "existing_install_msg": "There is already a Nexe installation at:\n\n%@\n\nWhat do you want to do?\n\n• Backup: we'll move the current one to %@ and install fresh.\n• Overwrite: it will be deleted and reinstalled (no recovery).",
            "existing_install_backup": "Back up and continue",
            "existing_install_overwrite": "Overwrite",
            "existing_install_change": "Choose another folder",
            "backup_done_title": "Backup created",
            "backup_done_msg": "The previous installation was moved to:\n\n%@\n\nYou can delete it manually whenever you want.",
            ...
            "model_tab_tier_24": "24 GB",
            "model_tab_tier_32": "32 GB+",
            "model_test_mode": "TEST MODE — simulated RAM: %@ GB (real: %@ GB). The wizard picks models from this number, not from your machine.",
            "model_tab_tier_48": "48 GB",
            "model_tab_tier_64": "64 GB",
            "model_engine": "Engine",
            ...
            "model_catalog_error": "The model catalog could not be loaded. The list is empty for that reason, not because no model fits your machine.",
