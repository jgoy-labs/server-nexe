...
MODEL_CATALOG = {
    ...
    "medium": [
        ...
        },
        {
            ...
            "disk_gb": 5.5,
            "ram_gb": 7.0,
            "description": {"ca": "Multimodal natiu, supera models de 30B anteriors. Llicència Apache 2.0", "es": "Multimodal nativo, supera modelos de 30B anteriores. Licencia Apache 2.0", "en": "Native multimodal, outperforms previous 30B models. Apache 2.0 license"},
            "mlx": None,
            "ollama": "qwen3.5:9b",
            "gguf": None,
            "chat_format": "chatml",
