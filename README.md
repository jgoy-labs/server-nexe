...
### Built to Grow
5109 tests (~85% coverage), security audits, i18n in 3 languages, comprehensive API. What started as an experiment is being built with production practices.
...
5109 tests collected (of 5261 total, 152 deselected by default markers) with ~85% code coverage. CI runs the full suite on every push.
...
<p align="center">
  <strong>Version 1.0.3-beta</strong> · Apache 2.0 · Made by <a href="https://www.jgoy.net">Jordi Goy</a> in Barcelona
</p>
